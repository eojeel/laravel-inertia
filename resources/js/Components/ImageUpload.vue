...
<template>
    <div>
        ...
        <label for="image" class="block rounded-md-1 bg-slate-300 h-[230px] overflow-hidden cursor-pointer border-slate-300 border"
               :class="{'!border-red-500': imageSize}" >
            <img :src="preview ?? defaultImage" class="object-cover object-center w-full h-full" />
